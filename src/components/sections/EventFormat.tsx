          ...
          <div className="relative flex flex-col justify-between p-6 md:min-h-[360px] md:p-9">
            ...
            <div className="relative">
              ...
              <div className="mt-8 flex flex-wrap items-end gap-x-4 gap-y-2">
                <span className="font-serif text-5xl font-bold leading-none text-gold-200 md:text-6xl">3.999.999</span>
                <span className="pb-2 text-lg font-semibold text-zinc-500 line-through md:text-xl">7.999.999</span>
              </div>
