    ...
    >
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        <button
          ...
          className={cn(
            'hidden lg:inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-sm font-black transition cursor-pointer',
            scrolled
              ? 'bg-[var(--cf-gold)] text-black hover:bg-[var(--cf-cream)] hover:text-[var(--cf-ink)]'
              : 'border border-gold-500/40 bg-black/25 text-gold-200 backdrop-blur-md hover:border-gold-300 hover:bg-black/40 hover:text-[var(--cf-cream)]'
          )}
        >
