...
const Speakers: React.FC = () => {
  const proofs = [
    ...
    '20+ tahun pengalaman di industri garmen dengan klien brand multinasional.',
    'Business owner dengan visi membawa bisnis menuju IPO Ready 2030.',
    'Founder & Advisor Alpha Leaders Community.',
    'Telah hadir di berbagai podcast dan media entrepreneur nasional.',
    'Membantu ratusan business owner skala ratusan miliar hingga triliunan rupiah membangun sistem bisnis yang lebih autopilot dan scalable.',
  ];
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-4 left-6 right-6 z-10 bg-[var(--cf-cream)] px-5 py-3 text-zinc-950 shadow-xl">
                  ...
                  <p className="text-sm font-bold mt-1 leading-snug">
                    Fokus pada strategic design & execution untuk sales team yang scalable.
                  </p>
                </div>
              </div>
            </FadeIn>
